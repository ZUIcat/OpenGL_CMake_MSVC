...
Rectangle::Rectangle(unsigned int texID01) : texID01(texID01), name("Rectangle") {}
...
void Rectangle::DrawSelf() {
    ...
    // matrix // TODO
    glUniformMatrix4fv(static_cast<int>(uMVPMatrixHandle), 1, GL_FALSE, glm::value_ptr(MartrixUtil::GetMVPMatrix()));
    // other buffer
    glBindVertexArray(VAO);
